...
const sourcePdfs: Record<WeekId, { src: string; pages: number }> = {
  1: { src: "/manus-storage/indojavider-week-1_6b731386.pdf", pages: 10 },
  2: { src: "/manus-storage/indojavider-week-2_e576d0b8.pdf", pages: 12 },
  3: { src: "/manus-storage/indojavider-week-3_f2091b6b.pdf", pages: 8 },
  4: { src: "/manus-storage/indojavider-week-4_a70190e2.pdf", pages: 10 },
};
